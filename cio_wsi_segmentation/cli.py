...
@click.option('--close_segmentation_um', type=float, default=20, help='Close segmentations with this window size in um')
@click.option('--erosion_expansion_um', type=float, default=5, help='Smooth the filled-gaps with ersion then expansion using this window size in um')
